      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <form onSubmit={handleRegister} className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-slate-500 px-3 py-1.5 text-sm font-semibold text-blue-400 shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
            >
              Sign Up
            </button>
            <div className='p-6'>
